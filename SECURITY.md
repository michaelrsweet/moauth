...
For the purposes of this project, a security bug is a software defect *in a*
*production release* that allows a *local or remote user* to gain unauthorized
access or privileges on the host computer or to cause the software to crash.
Such defects should be reported to the project security advisory page at
<https://github.com/michaelrsweet/moauth/security/advisories>.

> *Note:* If you've found a software defect that doesn't fall into this
> category, i.e., it is not in a production release, the defect doesn't grant
> unauthorized access or privileges on the host computer, that defect should be
